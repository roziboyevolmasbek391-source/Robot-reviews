...
const storageState = './storage/google.json';
const dashboardUrl = 'https://business.google.com/locations';

console.log('🚀 Google Business kabineti ochilmoqda...');
...
try {
  ...
  // Navigate to Google locations list
